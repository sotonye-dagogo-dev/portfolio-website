...
export const automationFlow: FlowNode[] = [
  { label: 'PRD', title: 'Requirements', status: 'completed', active: false },
  { label: 'Roadmap', title: 'Planning', status: 'completed', active: false },
  { label: 'Design', title: 'Architecture', status: 'completed', active: false },
  { label: 'Prompts', title: 'AI Generation', status: 'completed', active: false },
  { label: 'Open Design', title: 'Visual Contract', status: 'in-progress', active: true },
  { label: 'Open Code', title: 'Implementation', status: 'pending', active: false },
];
